"""
Usage:
    python gmc.py --video "../ex/track-train.mp4"
    python gmc.py --video "../ex/track-train.mp4" --x 960 --y 540
"""
...
from overlay import OverlayCleaner, pick_point_by_click, VX0, VX1
